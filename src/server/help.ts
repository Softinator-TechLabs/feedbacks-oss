...
<details><summary>Capture and review</summary><p>Right-click an element, type your comment beside its highlight, and save the point. Repeat on other elements, then choose <strong>Review screenshots</strong>. The screenshot editor keeps the numbered comments with their selected elements; an overall note is optional. Alt+click also works. Or open the extension icon and choose <strong>Capture this page</strong>. Screenshots include visible forms and frames without masking. Nothing uploads before Send. For automatic right-click review, choose <strong>Enable right-click on all websites</strong> separately. Pairing grants access only to your Feedbacks server.</p>
