...
| `github.statusSync`          | No                   | No                             |
| `github.statusSyncConfigure` | No                   | No                             |
| `github.statusSyncState`     | Yes                  | No                             |
| `guest.inspect`              | No                   | No                             |
| `guest.reply`                | No                   | No                             |
| `guestLinks.create`          | No                   | No                             |
| `guestLinks.list`            | No                   | No                             |
| `guestLinks.revoke`          | No                   | No                             |
| `guestProject.inspect`       | No                   | No                             |
| `guestProject.submit`        | No                   | No                             |
| `guestProjectLinks.create`   | No                   | No                             |
| `guestProjectLinks.list`     | No                   | No                             |
